...
The forward algorithm, and HMM inference in general, depends only on two quantities. The emission density $p(o_t \mid s_t)$ and the transition probability $p(s_t \mid s_{t-1})$.
