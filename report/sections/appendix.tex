...
This code was written with Python (version 3.11) and \texttt{uv} (version 0.9.7) \citep{astral_uv_docs} was used as a package manager.
...
\input{sections/diagrams/fig_01_composition}
\input{sections/diagrams/fig_02_emissions}
\input{sections/diagrams/fig_03_transitions}
\input{sections/diagrams/fig_04_inference}
\input{sections/diagrams/fig_05_solvers}
